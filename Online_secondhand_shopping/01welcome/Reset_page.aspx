<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reset_page.aspx.cs" Inherits="_01welcome_Reset_page" %>
...
<head runat="server">
    ...
    <title>Reset Password - Thrifty Finds</title>
                ...
                <div class="container py-5">
                    <div class="row mb-4 mb-lg-5">
                        <div class="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 class="fw-bold" style="padding-left: 18px;">Forgot Password?</h2>
                        </div>
                    </div>
                                ...
                                <div class="card-body text-center d-flex flex-column align-items-center">
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <asp:TextBox ID="password_txt" CssClass="form-control" placeholder="Password" runat="server" required="required" Style="width: 320.469px;" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@#$%^&+=])[A-Za-z\d@#$%^&+=]{8,}$" ToolTip="Password must contain: Minimum 8 characters at-least 1 Uppercase ,1 Number and 1 special character" TextMode="Password"></asp:TextBox>
                                        ...
                                        <div class="mb-3">
                                            <asp:Button ID="reset_btn" runat="server" Text="Reset" CssClass="btn btn-primary shadow d-block w-100" Style="padding-top: 9px; margin-bottom: -1px; padding-left: 33px; margin-right: 2px; margin-left: 2px; margin-top: 10px;" OnClick="reset_btn_Click" />
                                            <asp:Label ID="mess_lbl" runat="server" CssClass="text-success" Style="margin-left: 10px"></asp:Label>
                                        </div>
                                        <br />
                                        <p><a href="Help_info/forget.html">Get Help with password recovery.</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
