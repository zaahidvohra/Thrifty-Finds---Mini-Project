<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Team_page.aspx.cs" Inherits="_01welcome_Team_page" %>
...
<head runat="server">
    ...
    <title>Team - Thrifty Finds</title>
            ...
            <div class="container py-4 py-xl-5">
                <div class="row mb-4 mb-lg-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2 style="font-size: 41px;">Our Team</h2>
                        <p class="w-lg-50" style="padding: 24px;">Bringing life to our vision of a secondhand online shopping platform was a collaborative masterpiece. Our team, fueled by innovation and determination, turned concepts into a live project, creating a new world of possibilities in the realm of sustainable shopping.</p>
                    </div>
                </div>
                <div class="row gy-4 row-cols-2 row-cols-md-4" style="margin-bottom: 0px; padding-bottom: 48px; padding-top: 0px; margin-top: -42px;">
                    <div class="col">
                        <div class="card border-0 shadow-none">
                            <div class="card-body text-center d-flex flex-column align-items-center p-0">
                                <img class="rounded-circle mb-3 fit-cover" width="130" height="130" src="assets/img/man.png">
                                <h5 class="fw-bold text-primary card-title mb-0">Zaahid</h5>
                                <p class="text-muted card-text mb-2">Vohra</p>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-none">
                            <div class="card-body text-center d-flex flex-column align-items-center p-0">
                                <img class="rounded-circle mb-3 fit-cover" width="130" height="130" src="assets/img/woman.png">
                                <h5 class="fw-bold text-primary card-title mb-0">Khushi</h5>
                                <p class="text-muted card-text mb-2">Sidhpura</p>
                                <ul class="list-inline fs-6 text-muted w-100 mb-0">
                                    <li class="list-inline-item text-center">
                                        <div class="d-flex flex-column align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-none">
                            <div class="card-body text-center d-flex flex-column align-items-center p-0">
                                <img class="rounded-circle mb-3 fit-cover" width="130" height="130" src="assets/img/man.png">
                                <h5 class="fw-bold text-primary card-title mb-0">Aditya</h5>
                                <p class="text-muted card-text mb-2">Jadaon</p>
                                <ul class="list-inline fs-6 text-muted w-100 mb-0">
                                    <li class="list-inline-item text-center">
                                        <div class="d-flex flex-column align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-none">
                            <div class="card-body text-center d-flex flex-column align-items-center p-0">
                                <img class="rounded-circle mb-3 fit-cover" width="130" height="130" src="assets/img/man.png">
                                <h5 class="fw-bold text-primary card-title mb-0"><strong>Vedant</strong></h5>
                                <p class="text-muted card-text mb-2">Saparia</p>
                                <ul class="list-inline fs-6 text-muted w-100 mb-0">
                                    <li class="list-inline-item text-center">
                                        <div class="d-flex flex-column align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
