<%@ Page Title="" Language="C#" MasterPageFile="~/02adminpages/Admin.master" AutoEventWireup="true" CodeFile="Adm_Myads.aspx.cs" Inherits="_02adminpages_Adm_Myads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <asp:Repeater ID="rptrProducts" runat="server">
            <ItemTemplate>
                <a href="Adm_Adview.aspx?aid=<%# Eval("aid") %>" style="text-decoration: none; color: inherit;">
                    <div class="product-box">
                        ...
                        <div class="product-details">
                            ...
                            <h2><%#Eval("aname") %></h2>
                            <p><strong>Price:</strong><%#Eval("aprice") %></p>
